...
<script>
  ...
  export default{
    ...
    //定义ischoose变量，接收父组件传入的ischoose
    //父组件传的ischoose变量为true时表示选择按钮显示 ，ischoose为false时表示视频处理按钮显示
    props: ['ischoose'],
    data(){
      return {
        params:{
